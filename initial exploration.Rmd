...
=======
library(data.table)
>>>>>>> 923a898f87e75246041630578730d3230a189755
```
...
point_to_s <- function(lat, lon) {
  st_point(c(lat,lon)) %>%
    st_sfc(crs = 4326)
}

parking <- point_to_s(-72.680663, 42.448013) %>%
...
plot(parking_buffer)
=======
>>>>>>> a4326a19b3002f2befc921c8cf163c6e9fa37111
```
...
addMarkers(data=campgroundsf)%>%
addMarkers(data=parkingsf)
